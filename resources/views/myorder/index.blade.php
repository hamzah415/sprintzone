            ...
            <div class="border border-gray-200 rounded-xl mb-4 overflow-hidden">
                ...
                <div class="p-4 space-y-3">
                    @foreach ($order->items as $item)
                        @php
                            // CEK GAMBAR: variant dulu, baru produk
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                @if ($image)
                                    <img src="{{ asset('storage/' . $image) }}" class="w-12 h-12 rounded-lg object-cover">
                                @else
        ...
        @empty
            ...
            <div class="text-center py-16 text-gray-400">
                ...
                <a href="{{ route('products.etalase') }}"
                    class="text-orange-500 hover:underline text-sm mt-2 inline-block">
                    Belanja sekarang
                </a>
            </div>
