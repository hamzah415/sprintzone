                    ...
                    <div @click.outside="open = false"
                        ...
                        <div class="flex items-center justify-between mb-8">
                            ...
                            <div>
                                ...
                                <h2 class="text-3xl font-black italic uppercase">
                            ...
                            <button @click="open = false" class="text-2xl font-black text-gray-400 hover:text-black">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="text-xs uppercase text-gray-400 font-black mb-2">

                                Customer

                            </div>

                            <div class="text-xl font-black" x-text="order.customer">
                            ...
                            <template x-for="item in order.items">
                                ...
                                <div class="flex justify-between border-b pb-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-black" x-text="item.name">
