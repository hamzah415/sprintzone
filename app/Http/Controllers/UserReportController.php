...
class UserReportController extends Controller
{
    ...
    public function exportPDF(Request $request)
    {
        ...
        $users = User::withCount('orders')->withSum('orders', 'total_price')
        ...
        $tanggal = now()->format('d/m/Y'); //Untuk display
        $tanggalFile = now()->format('d-m-Y'); //Untuk filename

        $pdf = PDF::loadview('laporan.user.pdf', [
            'users' => $users,
            'totalUser' => $totalUser,
        ...
        return $pdf->download("laporan-user-{$tanggalFile}.pdf");
    }
}
